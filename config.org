...
;; Format on save (equivalent to lsp-format-buffer-on-save t)
;; Applied to all +lsp languages from init.el
(defun +my/eglot-format-on-save-h ()
  "Format buffer with eglot before saving."
  (when (eglot-managed-p)
    (eglot-format-buffer)))

;; (add-hook! '(;; C/C++ (+lsp +tree-sitter)
;;              c-mode-hook c++-mode-hook c-ts-mode-hook c++-ts-mode-hook
;;              ;; Java (+lsp +tree-sitter)
;;              java-mode-hook java-ts-mode-hook
;;              ;; JavaScript (+lsp +tree-sitter)
;;              js-mode-hook js-ts-mode-hook javascript-ts-mode-hook
;;              ;; Lua (+lsp +tree-sitter)
...
;;   (add-hook 'before-save-hook #'+my/eglot-format-on-save-h nil t))
#+end_src
