...
Emacs File Manager - use Emacs as a standalone file manager with dirvish/dired.

#+begin_src emacs-lisp
(use-package! efm-mode
  :commands (efm efm-mode efm-save-and-return efm-return efm-dired-find-file-other-frame)
  :config
  ;; Evil keybindings for EFM
  (map! :n "Z Z" #'efm-save-and-return
        :n "Z Q" #'efm-return)
  ;; Dired keybinding for opening in other frame (files only, dirs stay in same frame)
  (map! :map dired-mode-map
        :n "O" #'efm-dired-find-file-other-frame))
#+end_src
